...
> 译者注：
>
> 译者电脑同时安装了 python2.7 和 python3.6。
>
...
如果系统自带 Python 2.X ，我们又额外安装了 Python 3.X，我们需要告诉虚拟环境使用后者。我们可以找到 Python 3 的安装路径并通过以下命令使用该路径创建虚拟环境：
...
> 译者注：
>
> 译者习惯使用 Pycharm ，因此直接通过 Pycharm 创建虚拟环境，创建方法为：
...
现在，打开http://http://127.0.0.1:8000/blog/，我们会发现底部多了页码信息，点击后一页:

![papagination_1_1](/Users/apple/profile/django_by_example/blog/doc/figures/CH1/pagination.png)

> 译者注：
>
> 分页功能正常显示需要 Post 模型有 3 个以上对象，点击后一页后，后一页的url 变为 http://127.0.0.1:8000/blog/?page=2 ，点击previous会回到前一个页面，前一个页面的 url 由http://127.0.0.1:8000/blog/ 变为 http://127.0.0.1:8000/blog/?page=1。
